...
import { readPrOutcomes, type NormalizedPrOutcomePayload } from "./pr-outcome.js";
...
function isDisengagedOutcome(outcome: (NormalizedPrOutcomePayload & { repoFullName: string }) | undefined): boolean {
